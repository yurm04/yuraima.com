...
<div style="text-align: center">
  <img style="margin-bottom: 0;" src="../assets/pitchforks.gif"/>
  <p><small>Hold off on on the angry mob and hear me out.</small></p>
</div>
...
Strip out all the time I spent writing this post and picking out my favorite theme and this is easily the fastest I've ever been able to ship something to production. And I have to admit that everything I was promised about the JAMstack, Gatsby.js and Netlify have panned out.  It's no surprise it's taken me years to get around to putting up my own blog until now. It can be painful and time consuming to deal with setting up a server, installing a CMS, ensuring that everything is secure, and on and on it goes.  I was blown away by how easy and enjoyable the process has been thanks to the awesome folks building these incredible tools.

I don't expect everyone to take my word for it, so go check out the [videos](https://www.youtube.com/channel/UC8bRyfU7ycLXnEBfvdorpUg) from JAMstack Conf to experience what I did on that fateful Tuesday.  And if that's not enough to make a believer out of you, check out Gatsby.js and Netlify.  It'll be well worth the hour of your time.  And even if you decide that the JAMstack just isn't your _jam_, at least you'll know exactly what you're missing out on!
