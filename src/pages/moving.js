...
export default ({ location, data }) => {
  ...
  return (
    <Layout location={location} title={site.siteMetadata.title}>
      ...
      <ListItem name="End table" price={35} img={['endtable3', 'endtable4']}/>
      ...
      <ListItem name="Kitchen shit" price="???" img={['kitchen1', 'kitchen2', 'kitchen3']}>
        <Styled.p>There's a bunch of stuff here. Silverware, pots, pans, appliances, cookware, dining sets, cups, mugs. Tell me what you need and we'll figure out a fair price."</Styled.p>
        <Styled.ul>
          <Styled.li>Silverware set</Styled.li>
          <Styled.li>Plate set</Styled.li>
          <Styled.li>Bowls</Styled.li>
